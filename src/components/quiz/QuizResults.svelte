<script lang="ts">
    ...
    const profileName = writingStyle.name && writingStyle.name !== ""  ? writingStyle.name : createDefaultNameFromQuestion(writingStyle.answers);
            ...
            <div class="w-full flex flex-col sm:flex-row md:flex-row lg:flex-row justify-between m-auto gap-4 align-top">
                <div class="flex flex-col gap-4 py-2 items-start">
                    <div class="flex flex-row group max-w-96">
                        ...
                        />
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="mt-2 ml-2 h-5 w-5 text-white hidden group-hover:block" stroke="currentColor">
        ...
        <div class="flex flex-col md:flex-row mt-8 gap-4 ">
            ...
            <div class="flex flex-col md:w-1/2">
                <div class="mb-2 min-h-24">
                    ...
                    <p>Your personality, a reflection of you shaped by who you are and how people perceive you</p>
                </div>
                <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4">
                    {#each writingStyle.answers.slice(0, 6).sort((a, b) => (b.answer || 0) - (a.answer || 0)) as question, idx}
                    <ScoreCard
            ...
            <div class="flex flex-col md:w-1/2">
                <div class="mb-2 min-h-24">
                    <p class="text-left font-bold text-black text-2xl mb-2">Tone of Voice</p>
                ...
                <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
                    {#each writingStyle.answers.slice(6, 10).sort((a, b) => (b.answer || 0) - (a.answer || 0)) as question, idx}
                    <ScoreCard
                    title={question.title}
