...
<script lang="ts">
    ...
    import { getWritingPromptFromQuestions, checkIfAllQuestionsAnswered } from "../../lib/personality/prompt.ts";
...
<div class="flex flex-row justify-center m-4">
    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 flex flex-col justify-center items-center">
            ...
            <div class="flex flex-row w-full items-center gap-2 m-2">
                ...
                <div class="w-[50%] px-4 lg:w-5/12">
                    <div class="bg-gray-200 dark:bg-dark-3 relative h-2.5 w-full rounded-2xl">
                        <div
                            class="bg-blue-500 absolute {questionAnswerToProgress(question.answer)} h-full w-[20%] rounded-2xl"
                            >
                        </div>
                    </div>
                </div>
