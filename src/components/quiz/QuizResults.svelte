<script lang="ts">
  ...
  const writingStyleDefined =
    writingStyle && writingStyle.answers.every((a) => a.answer);
  const generatedPrompt = writingStyleDefined
    ? getWritingPromptFromQuestions(writingStyle)
    : "";
  const profileExists =
    writingStyle.id && writingStyle.id !== "" ? true : false;
  const profileName =
  ...
  {#if !writingStyleDefined}
    <div class="w-full flex flex-col items-center justify-center">
      ...
      <p class="text-lg text-gray-500">
        Try to <a href="/quiz" class="text-blue-500">take the quiz</a> to generate
        a writing style
      </p>
    </div>
  {:else}
    <div class="w-full p-1 sm:p-2 flex flex-col gap-2">
      ...
      <div class="mt-4 mb-4">
        ...
        >
          ...
          <div class="flex flex-row gap-4">
            <ClipboardButton
              ...
              tooltipText={"Copy the Prompt so you can super easily use your personality in ChatGPT or other LLM. 😊"}
            />
            {#if profileExists}
        ...
        <div class="mb-4 p-2 py-4 rounded bg-white/50 mt-4">
          <p class="text-sm">
            To use it, <b
              >simply copy the prompt using the "Copy Prompt" button</b
            >
            or <b>check our documentation</b> for
            <a href="/doc/chatgpt-guide" class="text-blue-500">ChatGPT</a>,
            <a href="/doc/huggingchat-guide" class="text-blue-500"
              >HuggingChat</a
            >,
            <a href="/doc/google-gemini-guide" class="text-blue-500"
              >Google Gemini</a
            >
            or
            <a href="/doc/copilot-guide" class="text-blue-500"
              >Microsoft Copilot</a
            >.
          </p>
        </div>
        ...
        <div class="flex flex-col md:flex-row mt-8 gap-4">
          ...
          <div class="flex flex-col md:w-1/2">
            <div class="mb-2 min-h-24">
              ...
              <p>
                Your personality, a reflection of you shaped by who you are and
