  ...
  <div class="flex flex-col items-center m-32">
    {#if enableSubmit}
      ...
      <p class="text-lg text-black mb-4">
        You have made changes to an existing profile. Save the changes by
        clicking below
      </p>
    ...
    {:else}
      ...
      <p class="text-lg text-black mb-4">
        You must answer all questions before saving your updated writing style.
      </p>
      <div class="flex flex-row flex-wrap justify-center">
        ...
        {#if !englishAnswered}
          <div class="flex justify-between m-1">
            <button
              class="btn text-white font-bold bg-primary-500"
              on:click={scrollBackToAnswer(answers.length)}
              >"English Type"</button
            >
          </div>
        {/if}
