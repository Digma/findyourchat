...
<div class="flex flex-row justify-center m-4">
    ...
    >
                        ...
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <table
                                        class="min-w-full text-left text-md font-light text-surface dark:text-white">
                                        <tbody>
                                            {#each styles as style, index}
                                            <tr class="border-b border-neutral-200 transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-white/10 dark:hover:bg-neutral-200/15">
                                                <td class="whitespace-nowrap font-bold px-6 py-4 min-w-96 ">
                                                    <InlineInput value={style.name} on:blur={updateProfileName(style.id)}/>
                                                </td>
                                                <td class="whitespace-nowrap px-6 py-4 italic">
                                                    <p>Last modified {style.modified_at}</p>
                                                </td>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 m-auto">
                                                    <a class="flex flex-row items-center gap-2 text-white p-0" href="/quiz" on:click={loadProfileToEdit(style.writingStyle)}>
                                                        <span>
        ...
        <div class="w-full flex flex-col mt-16">
            <a
                class="w-88 text-lg font-bold m-auto text-center bg-orange-accent text-white px-6 py-4 rounded-lg"
                href="/quiz">Add new Style</a
            >
        </div>
    </div>
</div>
