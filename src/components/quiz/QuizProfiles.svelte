<script lang="ts">
    ...
    import { currentWritingStyle, saveProfile, editProfile, userRecord } from "../../lib/store.ts";
                                            ...
                                            <tbody>
                                                {#each styles as style, index}
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <CopyButtonWithOptions
                                                                tooltipText={style.prompt}
                                                            />
                                                        </td>
                                                        <div>
                                                            {#if open}
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <h2
                                                                            class="text-xl mb-4 align-center"
                                                                        >
                                                        ...
                                                        <td
                                                            class="whitespace-nowrap px-2 py-2 md:m-auto"
                                                        >
                                                            <a
