...
{/if}
{#if !formSubmitted}
    <form class="group mt-4 mb-4 flex max-w-xl flex-col items-center mx-auto" on:submit={submit} novalidate>
        <div class="flex w-full flex-col gap-2 sm:flex-row">
            <div class="w-full ">
                <input
                    ...
                    required
                />
                <span class="mt-2 hidden text-sm text-red-500 text-center peer-[&:not(:placeholder-shown):not(:focus):invalid]:block">
